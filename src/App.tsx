...
import {
	fetchPublicTastings,
	fetchTastings,
} from "features/tasting/tastingSlice";
		...
		<Routes>
			<Route path="/" element={<Layout />}>
				...
				<Route path="/tastings">
					...
					<Route
						path=":id"
						element={<ProtectedRoute component={<ViewTasting />} />}
					/>
					<Route
						path="new"
						element={<ProtectedRoute component={<NewTasting />} />}
					/>
					<Route
						path="edit"
						element={<ProtectedRoute component={<EditTasting />} />}
					/>
				</Route>
				...
				<Route path="/cellar">
					...
					<Route
						path=":id"
						element={<ProtectedRoute component={<ViewWine />} />}
					/>
					<Route
						path="new"
						element={<ProtectedRoute component={<NewWine />} />}
					/>
					<Route
						path="edit"
						element={<ProtectedRoute component={<EditWine />} />}
					/>
				</Route>
